...
class Nosotros extends Component {
    ...
    render() {
        return (
            <div className="nosotros">
                ...
                <div className="present">
                    ...
                    <p>En FixterGeek comprendemos la importancia de la tecnología en las siguientes décadas,
        ...
        que las más grandes oportunidades son a base de conocimientos y habilidades.
                        <br/>
            <br />
            Es por ello que en FixterGeek buscamos empoderar a nuestros jóvenes para que apreovechen esta
        ...
        acceso a todas estas opciones suelen estar por encima de de la economía promedio de un estudiante latino,
        ...
        profesional con aspiraciones internacionales sin los costos enormes de la escuela tradicional o bootcamps.
            <br/>
                        <br/>
